...
namespace QS.Tests
{
    ...
    public class TypeWithDateTimeSerializedAsString {
        [JsonConverter(typeof(QuikSharp.HHMMSSDateTimeConverter))]
    ...
    public class TransactionSpecTest {
        ...
        DebugFunctions _df;
        public TransactionSpecTest(Quik quik, IQuikTransport transport)
        {
            _df = new DebugFunctions(transport);
        ...
        //    var t = new Transaction();
        //    var result = _q..SendTransaction(t).Result;
