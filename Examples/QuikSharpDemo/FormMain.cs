    ...
    public partial class FormMain : Form
    {
        ...
        private void ButtonStart_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (checkBoxRemoteHost.Checked) _quik = new Quik();    // инициализируем объект Quik с использованием удаленного IP-адреса терминала
                else _quik = new Quik();    // инициализируем объект Quik с использованием локального расположения терминала (по умолчанию)
            }
            catch
            {
