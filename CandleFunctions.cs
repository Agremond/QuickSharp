...
namespace QuikSharp
{
    ...
    public class CandleFunctions
    {
        ...
        public async Task<int> GetNumCandles(string graphicTag)
        {
            ...
            return await _transport.SendAsync<Message<string>, int>(message, "get_num_candles").ConfigureAwait(false);
        }
        ...
        public async Task<List<Candle>> GetCandles(string graphicTag, int line, int first, int count)
        {
            ...
            return await _transport.SendAsync<Message<string>, List<Candle>>(message, "get_candles").ConfigureAwait(false);
        }
        ...
        public async Task<List<Candle>> GetLastCandles(string classCode, string securityCode, CandleInterval interval, int count, string param = "-")
        {
            ...
            return await _transport.SendAsync<Message<string>, List<Candle>>(message, "get_candles_from_data_source").ConfigureAwait(false);
        }
        ...
        public async Task Subscribe(string classCode, string securityCode, CandleInterval interval, string param = "-")
        {
            ...
            await _transport.SendAsync<Message<string>, string>(message, "subscribe_to_candles").ConfigureAwait(false);
        }
        ...
        public async Task Unsubscribe(string classCode, string securityCode, CandleInterval interval, string param = "-")
        {
            ...
            await _transport.SendAsync<Message<string>, string>(message, "unsubscribe_from_candles").ConfigureAwait(false);
        }
        ...
        public async Task<bool> IsSubscribed(string classCode, string securityCode, CandleInterval interval, string param = "-")
        {
            ...
            return await _transport.SendAsync<Message<string>, bool>(message, "is_subscribed").ConfigureAwait(false);
        }
    }
}